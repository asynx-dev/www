...
excerpt: Use an ad blocker if you wish
permalink: /privacy/
date: 2022-01-29
toc: true
---
...
**Use an ad blocker to limit tracking to minimum.**

You may also tweak your browser settings related to privacy. Even if you do it,
hosting platforms (we use GitHub Pages + Cloudflare) logs your IP address and
visited URLs (like all servers). After some time, logs are deleted (hopefully).
We don't have control their log rotation mechanisms.

We use Google Analytics, Google Adsense, Statcounter, Cloudflare Web Analytics
and Disqus as a 3rd party services. Also some 3rd party font and JavaScript
libraries are included. Using an ad blocker will probably deny all possible
tracking codes from all these services which is fine for us.

# Policy Text

Here is the [auto-generated](https://getterms.io) text.

```text

Privacy Policy

Your privacy is important to us. It is asynx.dev's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, https://asynx.dev, and other sites we own and operate.


This policy is effective as of 29 January 2022 and was last updated on 29 January 2022.
...
We are using Cloudflare as CDN provider with our primary hosting platform,
GitHub Pages. Also Cloudflare Web Analytics to see some stats.
Check [Cloudflare Privacy Policy](https://www.cloudflare.com/privacypolicy/).
...
Visit: <https://support.google.com/analytics/answer/4597324?hl=en>

## Google Adsense

Visit: <https://support.google.com/adsense/answer/1348695?hl=en>

# Statcounter

We use Statcounter as analytics service.

Visit: <https://statcounter.com/about/legal/#privacy>
...
We use Disqus to provide comments under posts.

Visit: <https://help.disqus.com/en/articles/1717103-disqus-privacy-policy>
